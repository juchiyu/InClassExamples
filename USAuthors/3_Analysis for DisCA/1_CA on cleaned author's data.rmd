...
```{r}
FrEnAuthors.unblnc <- FrEnAuthors
FrEnAuthors <- FrEnAuthors.blnc
...
# Run CA
```{r}
data.dx.unblnc <- data.dx
data.dx <- data.dx.blnc
...
```{r}
checkPoe <- FrEnAuthors[c("Poe, Edgar Allan", "Poedelaire", "Baudelaire, Charles"),]
